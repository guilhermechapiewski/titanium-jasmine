...
* "SampleApp/Resources/test/test_main.js":https://github.com/guilhermechapiewski/titanium-jasmine/blob/master/SampleApp/Resources/test/test_main.js is a sample file that contains the actual tests. You can (should) create as many files as you want, just remind to import all the modules on *tests.js*.
