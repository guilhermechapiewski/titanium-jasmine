...
// in simulator we redefine to format for SampleApp Developer console
...
{\
	NSString * exceptionName = [@"org.sampleapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sampleapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISampleAppNativeItemNone = -1, 
	UISampleAppNativeItemSpinner = -2,
	UISampleAppNativeItemProgressBar = -3,
	
	UISampleAppNativeItemSlider = -4,
	UISampleAppNativeItemSwitch = -5,
	UISampleAppNativeItemMultiButton = -6,
	UISampleAppNativeItemSegmented = -7,
	
	UISampleAppNativeItemTextView = -8,
	UISampleAppNativeItemTextField = -9,
	UISampleAppNativeItemSearchBar = -10,
	
	UISampleAppNativeItemPicker = -11,
	UISampleAppNativeItemDatePicker = -12,
	
	UISampleAppNativeItemInfoLight = -13,
	UISampleAppNativeItemInfoDark = -14,
	
	UISampleAppNativeItemDisclosure = -15,
	
	UISampleAppNativeItemContactAdd = -16
};
